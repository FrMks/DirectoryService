             ...
             Result<DepartmentDtoWithLazyLoadingOfChildren[], Errors>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var departments = await GetDepartmentsWithLazyLoadingOfChildrenCachedAsync(
            query.DepartmentId,
            page,
            pageSize,
            offset,
    ...
    private async Task<DepartmentDtoWithLazyLoadingOfChildren[]> GetDepartmentsWithLazyLoadingOfChildrenCachedAsync(
        Guid departmentId,
        int page,
        int pageSize,
        int offset,
        CancellationToken cancellationToken)
    {
        var cacheKey = $"department_children_lazy_department_{departmentId}_page_{page}_size_{pageSize}";
